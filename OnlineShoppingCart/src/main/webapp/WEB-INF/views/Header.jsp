...
<h3 style="text-align:center;">KONJETI's SHOPPING MALL</h3>
			
		<div class="navbar-header">
			<a href="" class="navbar-brand">
			
			<img
				src="<c:url value='/resources/images/niit.jpg'> </c:url>" alt="NIIT" height="30px"
				width="70px"></a>
		...
		<div class="collapse navbar-collapse" id="navbardemo">
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					...
					</ul> <security:authorize access="hasRole('ROLE_ADMIN')">
